...
WebUI.setText(findTestObject('Object Repository/Page_Automation Step by Step/input_Email_email123'), 'shiu@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Automation Step by Step/input_Password_psw'), 'PGKSAYww6LpMIpNUxgEeMA==')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Automation Step by Step/input_Repeat Password_psw-repeat'), 
    'PGKSAYww6LpMIpNUxgEeMA==')
