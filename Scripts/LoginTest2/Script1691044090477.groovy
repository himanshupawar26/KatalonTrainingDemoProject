...
WebUI.setText(findTestObject('Page_OrangeHRM/input_Username_username'), 'John Doe')

WebUI.setText(findTestObject('Page_OrangeHRM/input_Password_password'), 'ThisIsNotAPassword')
