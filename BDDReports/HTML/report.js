...
formatter.step({
  "name": "user is on login page enters \u003cusername\u003e and \u003cpassword\u003e",
  "keyword": "Given "
});
formatter.step({
...
formatter.step({
  "name": "user is on login page enters Admin and admin123",
  "keyword": "Given "
});
formatter.match({
  "location": "LoginSteps.user_is_on_login_page_enters_username_and_password(String,String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.step({
  "name": "user is on login page enters Admin123 and shivani",
  "keyword": "Given "
});
formatter.match({
  "location": "LoginSteps.user_is_on_login_page_enters_username_and_password(String,String)"
